...
class PostController extends Controller
{
    ...
    public function view($post_id){
        ...
        return view('posts.view',['posts' => $posts,
         'categories'=>$categories, 'likeCtr' => $likeCtr, 'dislikeCtr' => $dislikeCtr,
          'comments'=> $comments]);
    }
    ...
    public function editPost(Request $request, $post_id){
      ...
      public function like($id){
          ...
          $like_user = Like::where(['user_id' =>
          $loggedin_user, 'post_id' => $id])->first();
      ...
      public function dislike($id){
          $loggedin_user = Auth::user()->id;
          $like_user = Dislike::where(['user_id' =>
          $loggedin_user, 'post_id' => $id])->first();
          if(empty($like_user->user_id)){
              $user_id = Auth::user()->id;
              $email = Auth::user()->email;
      ...
      $comment->save();
      return redirect("/view/{$post_id}")->with('response', 'Comment Posted!');
    }
